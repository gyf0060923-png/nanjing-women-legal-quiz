const questions = [
  {
    ...
    answer: 0,
    analysis: "根据《中华人民共和国妇女权益保障法》第四十三条，用人单位在招录（聘）过程中，不得实施其他以性别为由拒绝录（聘）用妇女或者差别化地提高对妇女录（聘）用标准的行为。本案中，AI系统基于含有性别偏见的历史数据，降低女性求职者的匹配评分与通过率，属于对女性求职者的差别化对待。根据《中华人民共和国个人信息保护法》第二十四条，个人信息处理者利用个人信息进行自动化决策，应当保证决策的透明度和结果公平、公正，不得对个人在交易条件上实行不合理的差别待遇。AI招聘系统的评分筛选属于自动化决策，其歧视性结果与上述公平、公正要求相悖。"
  },
  {
    category: "合同相关维权",
